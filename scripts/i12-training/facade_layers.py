...
FOLD_PATH = join(PROJECT_ROOT, 'data/training/independant_12_layers/fold_{:02}'.format(FOLD))
...
class TrainInputLayer(pyfacades.models.independant_12_layers.caffe_layers.InputLayer):
    def __init__(self, p_object, *args, **kwargs):
        ...
        self.files = [join(PROJECT_ROOT, l.strip()) for l in open(self.source).readlines()]
